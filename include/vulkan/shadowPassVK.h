...
namespace MiniEngine
{
    ...
    public:
        ...
        static constexpr uint32_t MAX_SHADOW_LAYERS = 10;
    ...
    private:
        ...
        struct MaterialPipeline
        {
            ...
            std::array<VkPipelineShaderStageCreateInfo, 2>   m_shader_stages;           // Shader stages (vertex + geometry).
        };

        // Private Members
        // ---------------------------------------------------

        MaterialPipeline                 m_pipeline;          // Single pipeline for all entities in shadow pass.
        ...
        const ImageBlock m_out_shadow_attachment; // Output depth image to write results into.
    };
};
